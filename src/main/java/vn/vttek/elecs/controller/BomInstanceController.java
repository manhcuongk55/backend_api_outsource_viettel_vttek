...
public class BomInstanceController {
    ...
    public ResponseEntity<String> updateBominstance(@PathVariable Long bominstanceId,
                                                    @Valid @RequestBody BomInstance bominstanceRequest) {
        BomInstance bominstance = bominstanceRepository.findOne(bominstanceId);
        ...
        bominstanceRepository.save(bominstance);
        return ResponseEntity.ok().body("Update bom successfully!");
    }


    @DeleteMapping("/bominstance/{bominstanceId}")
    public ResponseEntity<String> deleteBominstance(@PathVariable Long bominstanceId) {
        bominstanceRepository.delete(bominstanceId);
        return ResponseEntity.ok().body("Delete bom successfully");
    }
}
