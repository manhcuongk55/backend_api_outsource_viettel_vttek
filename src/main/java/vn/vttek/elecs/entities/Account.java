...
public class Account {
    ...
    public Account(@NotBlank @Size(min = 3, max = 50) String name, @NotBlank @Size(min = 3, max = 50) String username, @NotBlank @Size(max = 50) @Email String email, @NotBlank @Size(min = 6, max = 100) String password, String gender, int identify_number, String grand_permission, String department_id, String state, Date created_on, int enabled, Set<Role> roles) {
        this.name = name;
        this.username = username;
        this.email = email;
        this.password = password;
